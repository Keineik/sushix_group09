    ...
    <div className="account-page container mt-4">
      <div className="row">
        <div className="col-md-3">
          <div className="card mb-4" style={{ maxHeight: '100px', border: '1px solid #ddd', borderRadius: '8px', boxShadow: '0 4px 6px rgba(0, 0, 0, 0.1)', overflow: 'hidden', position: 'relative' }}>
            <div className="card-body p-3">
              <h5 className="card-title mx-4 my-2" style={{ fontSize: '1.2rem', fontWeight: 'bold', color: '#333' }}>Tài khoản của</h5>
